...
> 本書は、RDEToolKit(後述)の "バージョン1.2.0" に対応しています。
...
現時点(2025年05月)では、以下のバージョンをご利用ください。

* Python 3.12.x

> 特に問題がない場合は、Python3.12の中の最新版をお使いください。

RDETooKitが利用する外部ライブラリは、RDEToolKitに付随するrequirements.txtに記述されていますので、RDEToolKitインストール時に、指定されたライブラリの、指定されたバージョンが同時にインストールされます。
